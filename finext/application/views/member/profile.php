...
<section class="forms-section">
            ...
            <p style="color: <?php if($data->active_status==0){echo "red";} else if($data->active_status==1){echo "green";}else{echo "block";}?>"> <i class="fa fa-circle"></i></p>
                      </li>
                       <hr class="mb-4">
 ...
 <input type="submit" name="upload" id="upload" value="Upload" class="btn btn-info" />  
                    ...
                    <div class="outer-w3-agile col-xl-7 ml-xl-3 mt-xl-0 mt-3 profile">
                        ...
                        <form action="<?php echo base_url()?>member/member/edit_profile" method="post" class="needs-validation" novalidate="">
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <label for="firstName">Name :</label>
                                        <input type="text" class="form-control" id="firstName" name="name" placeholder=""  value="<?php echo $data->name;?>" required="">
                                     ...
                                     <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="firstName" placeholder=""name="email"  value="<?php echo $data->email;?>" required="">
                                        <div class="invalid-feedback">
                                     ...
                                     <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="firstName" placeholder=""name="mobile"  value="<?php echo $data->mobile;?>" required="">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="firstName" placeholder=""name="nomini"  value="<?php echo $data->nomini;?>" required="">
                                        <div class="invalid-feedback">
                                     ...
                                     <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="firstName" placeholder=""name="relation"  value="<?php echo $data->relation;?>" required="">
                                        <div class="invalid-feedback">
