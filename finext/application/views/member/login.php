...
<head>
    ...
    <!-- Bootstrap Css -->
    <!-- Common Css -->
    <link href="<?php echo base_url(); ?>assets/css/admin_style.css" rel="stylesheet" type="text/css" media="all" />
    <!--// Common Css -->
    <!-- Fontawesome Css -->
    ...
    <div class="bg-page py-5">
        <div class="container">
            ...
            <div class="copyright-w3layouts py-xl-3 py-2 mt-xl-5 mt-4 text-center">
                <p>© <?php echo date('Y'); ?>   All Rights Reserved | Design by
                    <a href="#"> Grepthor Software Pvt. Ltd. </a>
                </p>
            </div>
            <!--// Copyright -->
        </div>
