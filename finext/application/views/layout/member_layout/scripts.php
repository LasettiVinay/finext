 ...
 $(document).ready(function(){  
    ...
    alert('hello');
           ...
           {  
              var url="<?php echo base_url(); ?>admin/admin/ajax_upload";
               alert(url);
                $.ajax({  
                     url:"<?php echo base_url(); ?>member/member/ajax_upload",   
 ...
 $(document).ready(function(){  
      ...
      $('#upload_kyc').on('submit', function(e){  
    	  alert('hello');
           e.preventDefault();  
           if($('#image_file').val() == '')  
           {  
           ...
           {  
              var url="<?php echo base_url(); ?>member/member/kyc_upload";
                     $.ajax({  
                     url:"<?php echo base_url(); ?>member/member/kyc_upload",   
                     //base_url() = http://localhost/tutorial/codeigniter  
                     method:"POST",  
                     data:new FormData(this),  
                     contentType: false,  
