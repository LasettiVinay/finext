...
<div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                            ...
                            <form action="<?php echo base_url();?>member/member/bank_detail" method="post">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="inputPassword3" name="ifsc" placeholder="IFSC" required="" value="<?php echo $bank_list->ifsc?>">
                                    </div>
                                </div>
